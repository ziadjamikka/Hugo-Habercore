...
DATA_DIR = r"data"
BEST_MODEL_PATH = r"improved_models\improved_behavior_model\weights\best.pt"

timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
OUTPUT_MODEL_DIR = os.path.join(DATA_DIR, f"improved_models_{timestamp}")
...
def train_updated_model():
    ...
    print(f"\nNew improved model saved in: {os.path.join(OUTPUT_MODEL_DIR, output_name)}")
